/*
  ...
  - You are about to drop the `chargerRuntimeState` table. If the table is not empty, all the data it contains will be lost.
...
CREATE TABLE `ChargerRuntimeState` (
    ...
    `connectionStatus` ENUM('CONNECTED', 'DISCONNECTED') NULL,
    `errorCode` VARCHAR(191) NULL,
    `lastStatusUpdate` DATETIME(3) NULL,
    `bookingId` VARCHAR(191) NULL,
    `internalTransactionId` INTEGER NULL,
    ...
    INDEX `ChargerRuntimeState_connectionStatus_idx`(`connectionStatus`),
    INDEX `ChargerRuntimeState_transactionId_idx`(`transactionId`),
